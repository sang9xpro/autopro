...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './most-of-cont-fields.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOSTOFCONTFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_MOSTOFCONTFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MOSTOFCONTFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MOSTOFCONTFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MOSTOFCONTFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MOSTOFCONTFIELDS actions', async () => {
      const expectedActions = [
        {

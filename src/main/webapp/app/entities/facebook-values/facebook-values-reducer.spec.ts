...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACEBOOKVALUES_LIST actions', async () => {
    ...
    it('dispatches FETCH_FACEBOOKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FACEBOOKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FACEBOOKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FACEBOOKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FACEBOOKVALUES actions', async () => {
      const expectedActions = [
        {

...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './applications-fields.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICATIONSFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLICATIONSFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLICATIONSFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLICATIONSFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLICATIONSFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLICATIONSFIELDS actions', async () => {
      const expectedActions = [
        {

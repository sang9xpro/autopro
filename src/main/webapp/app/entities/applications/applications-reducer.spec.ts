...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICATIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLICATIONS actions', async () => {
      const expectedActions = [
        {

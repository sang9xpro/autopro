...
import { getEntity, deleteEntity } from './history.reducer';

export const HistoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="autoproApp.history.delete.question">
        <Translate contentKey="autoproApp.history.delete.question" interpolate={{ id: historyEntity.id }}>

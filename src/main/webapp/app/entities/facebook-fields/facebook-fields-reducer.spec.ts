...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACEBOOKFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FACEBOOKFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FACEBOOKFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FACEBOOKFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FACEBOOKFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FACEBOOKFIELDS actions', async () => {
      const expectedActions = [
        {

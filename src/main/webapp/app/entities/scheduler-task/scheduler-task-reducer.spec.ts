...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEDULERTASK_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCHEDULERTASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCHEDULERTASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCHEDULERTASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCHEDULERTASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCHEDULERTASK actions', async () => {
      const expectedActions = [
        {

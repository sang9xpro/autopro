...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './scheduler-task-values.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEDULERTASKVALUES_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCHEDULERTASKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCHEDULERTASKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCHEDULERTASKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCHEDULERTASKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCHEDULERTASKVALUES actions', async () => {
      const expectedActions = [
        {

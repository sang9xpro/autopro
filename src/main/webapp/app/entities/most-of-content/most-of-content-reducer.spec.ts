...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOSTOFCONTENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_MOSTOFCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MOSTOFCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MOSTOFCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MOSTOFCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MOSTOFCONTENT actions', async () => {
      const expectedActions = [
        {

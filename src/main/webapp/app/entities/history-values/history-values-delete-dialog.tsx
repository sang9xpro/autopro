...
export const HistoryValuesDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(historyValuesEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="autoproApp.historyValues.delete.question">
        <Translate contentKey="autoproApp.historyValues.delete.question" interpolate={{ id: historyValuesEntity.id }}>
...
export default HistoryValuesDeleteDialog;

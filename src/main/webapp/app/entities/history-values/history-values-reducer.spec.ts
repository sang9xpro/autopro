...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HISTORYVALUES_LIST actions', async () => {
    ...
    it('dispatches FETCH_HISTORYVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HISTORYVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HISTORYVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HISTORYVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HISTORYVALUES actions', async () => {
      const expectedActions = [
        {

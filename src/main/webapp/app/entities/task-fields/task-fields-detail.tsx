...
export const TaskFieldsDetail = (props: RouteComponentProps<{ id: string }>) => {
    ...
    <Row>
      <Col md="8">
        <h2 data-cy="taskFieldsDetailsHeading">
          <Translate contentKey="autoproApp.taskFields.detail.title">TaskFields</Translate>
        </h2>
...
export default TaskFieldsDetail;

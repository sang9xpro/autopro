...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TASKFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TASKFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TASKFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TASKFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TASKFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TASKFIELDS actions', async () => {
      const expectedActions = [
        {

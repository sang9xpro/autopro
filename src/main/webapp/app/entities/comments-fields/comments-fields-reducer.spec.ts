...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMENTSFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMMENTSFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMENTSFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMENTSFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMENTSFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMENTSFIELDS actions', async () => {
      const expectedActions = [
        {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOGGERSFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOGGERSFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOGGERSFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOGGERSFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOGGERSFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOGGERSFIELDS actions', async () => {
      const expectedActions = [
        {

...
export const DeviceValuesDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(deviceValuesEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="autoproApp.deviceValues.delete.question">
        <Translate contentKey="autoproApp.deviceValues.delete.question" interpolate={{ id: deviceValuesEntity.id }}>
...
export default DeviceValuesDeleteDialog;

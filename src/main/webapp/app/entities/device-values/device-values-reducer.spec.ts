...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEVICEVALUES_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEVICEVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEVICEVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEVICEVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEVICEVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEVICEVALUES actions', async () => {
      const expectedActions = [
        {

...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './applications-values.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICATIONSVALUES_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLICATIONSVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLICATIONSVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLICATIONSVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLICATIONSVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLICATIONSVALUES actions', async () => {
      const expectedActions = [
        {

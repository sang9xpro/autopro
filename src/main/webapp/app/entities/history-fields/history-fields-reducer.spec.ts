...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HISTORYFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_HISTORYFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HISTORYFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HISTORYFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HISTORYFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HISTORYFIELDS actions', async () => {
      const expectedActions = [
        {

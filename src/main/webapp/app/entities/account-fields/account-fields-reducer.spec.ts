...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCOUNTFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTFIELDS actions', async () => {
      const expectedActions = [
        {

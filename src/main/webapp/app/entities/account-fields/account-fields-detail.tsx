...
export const AccountFieldsDetail = (props: RouteComponentProps<{ id: string }>) => {
    ...
    <Row>
      <Col md="8">
        <h2 data-cy="accountFieldsDetailsHeading">
          <Translate contentKey="autoproApp.accountFields.detail.title">AccountFields</Translate>
        </h2>
...
export default AccountFieldsDetail;

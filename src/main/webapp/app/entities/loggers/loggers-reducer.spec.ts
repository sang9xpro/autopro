...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './loggers.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOGGERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOGGERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOGGERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOGGERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOGGERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOGGERS actions', async () => {
      const expectedActions = [
        {

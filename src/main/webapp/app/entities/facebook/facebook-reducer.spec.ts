...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './facebook.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACEBOOK_LIST actions', async () => {
    ...
    it('dispatches FETCH_FACEBOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FACEBOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FACEBOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FACEBOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FACEBOOK actions', async () => {
      const expectedActions = [
        {

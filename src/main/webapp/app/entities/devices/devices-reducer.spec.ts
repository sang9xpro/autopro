...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './devices.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEVICES_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEVICES actions', async () => {
      const expectedActions = [
        {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEVICESFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEVICESFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEVICESFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEVICESFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEVICESFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEVICESFIELDS actions', async () => {
      const expectedActions = [
        {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TASKVALUES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TASKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TASKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TASKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TASKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TASKVALUES actions', async () => {
      const expectedActions = [
        {

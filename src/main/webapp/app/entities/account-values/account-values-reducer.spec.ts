...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTVALUES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCOUNTVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTVALUES actions', async () => {
      const expectedActions = [
        {

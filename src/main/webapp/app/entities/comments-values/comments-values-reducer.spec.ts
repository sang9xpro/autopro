...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMENTSVALUES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMMENTSVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMENTSVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMENTSVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMENTSVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMENTSVALUES actions', async () => {
      const expectedActions = [
        {

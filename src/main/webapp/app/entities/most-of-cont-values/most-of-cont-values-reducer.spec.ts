...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './most-of-cont-values.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOSTOFCONTVALUES_LIST actions', async () => {
    ...
    it('dispatches FETCH_MOSTOFCONTVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MOSTOFCONTVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MOSTOFCONTVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MOSTOFCONTVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MOSTOFCONTVALUES actions', async () => {
      const expectedActions = [
        {

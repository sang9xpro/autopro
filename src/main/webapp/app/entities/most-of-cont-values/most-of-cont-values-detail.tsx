...
export const MostOfContValuesDetail = (props: RouteComponentProps<{ id: string }>) => {
    ...
    <Row>
      <Col md="8">
        <h2 data-cy="mostOfContValuesDetailsHeading">
          <Translate contentKey="autoproApp.mostOfContValues.detail.title">MostOfContValues</Translate>
        </h2>
...
export default MostOfContValuesDetail;

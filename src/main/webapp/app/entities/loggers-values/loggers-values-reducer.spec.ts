...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOGGERSVALUES_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOGGERSVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOGGERSVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOGGERSVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOGGERSVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOGGERSVALUES actions', async () => {
      const expectedActions = [
        {

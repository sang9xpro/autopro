...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tasks.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TASKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TASKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TASKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TASKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TASKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TASKS actions', async () => {
      const expectedActions = [
        {

...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './scheduler-task-fields.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEDULERTASKFIELDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCHEDULERTASKFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCHEDULERTASKFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCHEDULERTASKFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCHEDULERTASKFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCHEDULERTASKFIELDS actions', async () => {
      const expectedActions = [
        {
